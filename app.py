...
with tab_master_dashboard:
    @st.fragment
    def _render_tab_master_dashboard():
    ...
    _render_tab_master_dashboard()
# ==========================================
# Tab 0.5: 시장 동향 리서치
# ==========================================
with tab_market_research:
    @st.fragment
    def _render_tab_market_research():
    ...
    _render_tab_market_research()
with tab_asset_view:
    @st.fragment
    def _render_tab_asset_view():
    ...
    _render_tab_asset_view()
# ==========================================
# Tab 1.5: 스태킹 플랜
# ==========================================
with tab_stacking_plan:
    @st.fragment
    def _render_tab_stacking_plan():
    ...
    _render_tab_stacking_plan()
# ==========================================
# Tab 2: 자산별 임대정보 관리
# ==========================================
with tab_lease_info:
    @st.fragment
    def _render_tab_lease_info():
...
with tab_rent_roll:
    ...
    _render_tab_rent_roll()
# ==========================================
# Tab: 임관리비 변동 현황
# ==========================================
with tab_rent_change:
    @st.fragment
    def _render_tab_rent_change():
    ...
    _render_tab_rent_change()
# ==========================================
# Tab 4: 자산정보 업데이트
# ==========================================
with tab_asset_update:
    @st.fragment
    def _render_tab_asset_update():
    ...
    _render_tab_asset_update()
# ==========================================
# Tab 5: 계약 업데이트
# ==========================================
with tab_contract_update:
    @st.fragment
    def _render_tab_contract_update():
